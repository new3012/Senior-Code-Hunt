...
export async function getPlayerState(id: string) {
  ...
  const { startDate, bonusClue, bonusTitle, bonusUnlockTime, bonusSequenceRounds, bonusCodeAttempts, finalTitle, finalTask, finalHelp } = await settings();
